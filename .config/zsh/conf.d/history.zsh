...
# Note: HISTFILE is a zsh special parameter, so zsh uses it internally without needing export
# — but subprocesses like atuin won't inherit it unless it's explicitly exported.
